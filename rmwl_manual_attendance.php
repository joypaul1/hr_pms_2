		...
		<form id="Form2" action="" method="post"></form>
			...
			if(isset($_POST['emp_id'])){
			   ...
			   $strSQL  = oci_parse($objConnect, 
			               "SELECT RML_ID,EMP_NAME,DEPT_NAME,DESIGNATION,BRANCH_NAME FROM RML_HR_APPS_USER WHERE R_CONCERN='RMWL' AND IS_ACTIVE=1 AND RML_ID ='$v_emp_id'"); 
				@oci_execute($strSQL);
				$number=0;
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <button form="Form2" type="submit" name="submit_attendance" class="btn btn-primary">Create Attendance</button>
                          </div>
                        </div>
