                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div style="width: 30%;">
                                                        ...
                                                        <input type="text" name="remark_1" oninput="limitCharter($(this))" class="form-control "
                                                            placeholder="All Document Submit ...">
                                                    </div>
                                                    <div style="width: 30%;">
                                                        <label class="form-label">Any Paymnet Due/Clear</label>
                                                        <input type="text" name="remark_2" oninput="limitCharter($(this))" class="form-control "
                                                            placeholder="Any Paymnet Due/Clear ...">
                                                    </div style="width: 30%;">
                                                    <div>
                                                        <label class="form-label">Any Other(Remarks)</label>
                                                        <input type="text" name="remark_3" oninput="limitCharter($(this))" class="form-control "
                                                ...
                                                <div class="mt-2 d-flex flex-row">
                                                    ...
                                                    <div class="col-6 d-flex flex-row">
                                                        ...
                                                        <a onclick="denied($(this))"
                                                            data-href="<?php echo $basePath . '/offboarding_module/action/lm_panel.php?id=' . "$row[ID]" . '&actionType=offboarding_denine' ?>"
