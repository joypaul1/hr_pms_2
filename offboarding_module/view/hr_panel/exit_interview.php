                            ...
                            if (isset($_POST['emp_concern'])) {
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input form="Form2" type="checkbox" name="check_list[]" value="<?php echo $row['ID']; ?>">
                                                <?php echo $number; ?>
                                                <a href="<?php echo $basePath . "/document/exit_interview.php?id=" . $row['ID'] . '&rml_id=' . $row['RML_ID'] ?>"
                                                    target="_blank">
                                ...
                                if ($v_view_approval > 0) {
                                    ?>
                                        <tr>
                                            <td>
                                                <input form="Form2" class="btn btn-primary btn pull-right" type="submit" name="submit_approval"
                                                    value="Approve">
                                            </td>
                                            <td>
