					...
					<!--<form action="" method="post">  -->
						<div class="row">
						    <div class="col-sm-8">
							    ...
							    <input required="" form="Form1" name="kra_name"  placeholder="Enter KRA Name" class="form-control"  type='text'/>
							</div>
							<div class="col-sm-4">
							<label for="exampleInputEmail1">Select PMS Title:</label>
								<select required=""  name="pms_title_id" class="form-control" form="Form1">
                          ...
                          <div class="col-sm-8"></div>						
							<div class="col-sm-4">
								<div class="md-form mt-3">
									<input class="form-control btn btn-primary" form="Form1" type="submit" value="Submit to Create">
								</div>
							</div>
						</div>
					</form>
						...
						if(isset($_POST['kra_name'])){
                          ...
                          $strStatus  = oci_parse($objConnect, 
