                                                    ...
                                                    <form action="<?php echo $basePath . "/pms_module/action/self_panel.php" ?>" method="post">
                                                        ...
                                                        <div class="d-flex  flex-column gap-2">
                                                            <input required
                                                                ...
                                                                value="<?php echo $row['ACHIVEMENT'] ?>" style="padding:5px !important" name="achivement"
                                                                placeholder="achivement" class="form-control text-center cust-control" type='number' <?php if ($existAchievement) {
                                                                    echo 'readonly';
                                                                } ?>>
                                                            <input required value="<?php echo $row['ACHIVEMENT_COMMENTS'] ? $row['ACHIVEMENT_COMMENTS'] : '' ?>"
