                        ...
                        ?>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input required="" class="form-control cust-control" type='text' name="eli_factor" value="<?php echo $row['ELIGIBILITY_FACTOR']; ?>" />
                                </div>
                            </div>
                            ...
                            ?>
                                <div class="row mt-2">
                                    <div class="col-sm-12">
                                        ...
                                        <input required="" class="form-control cust-control" type='text' name="achivement" value="<?php echo $row['ACHIVEMENT']; ?>" />
                                    </div>
                                </div>
                            <?php
                            }
