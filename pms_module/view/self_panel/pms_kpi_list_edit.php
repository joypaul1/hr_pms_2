    ...
    <div class="card">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between" style="padding: 1.0% 1rem">
                ...
                <div>
                    <a href="<?php echo $basePath ?>/pms_module/view/self_panel/pms_kpi_list.php" class="btn btn-sm btn-info"><i
                            class="menu-icon tf-icons bx bx-message-alt-add" style="margin:0;"></i>KPI List</a>
                </div>
            </div>
        </div>
        <div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select required="" name="weightage" class="form-control cust-control">
                                    <option selected value="<?php echo $row['WEIGHTAGE']; ?>">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input required="" class="form-control cust-control" type='number' readonly name="target"
                        ...
                        if ($row['ACHIEVEMENT_LOCK_STATUS'] == '1') {
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-12">
                                    ...
                                    <input required="" class="form-control cust-control" type='number' name="achivement"
                                        value="<?php echo $row['ACHIVEMENT']; ?>" />
                                </div>
                            </div>
                            <?php
                        }
