                                            ...
                                            <form action="<?php echo ($basePath . '/pms_module/action/hod_panel.php'); ?>" method="post"
                                                ...
                                                while ($kraRow = oci_fetch_assoc($KRASQL)) {
                                                    ...
                                                    while ($rowIN = oci_fetch_assoc($strSQLInner)) {
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-4">
                                                                <input type="text" value="<?php echo $rowIN['KPI_NAME']; ?>" disabled
                                                                    class="form-control text-center " placeholder="kpi name">
                                                            </div>
                                                            <div class="col-1">
                                                ...
                                                <div class="text-center">
                                                    <button type="submit" name="submit_confirm" class="btn btn-sm btn-warning">Confirm <i
