            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center ">
                        <div class="shadow-sm p-2 mb-3 text-center text-danger rounded font-weight-bold"><i class='bx bxs-shield-alt-2'></i>[Note :
                            Here You Can Set Min Value 0 and Max Value 10] <i class='bx bxs-shield-alt-2'></i></div>
                        <div class="card card-body">
                            <div class="shadow-sm p-2 mb-3 text-center rounded font-weight-bold"> HR Final RATING 
                                <i class='bx bxs-hand-down text-info'></i>
                            </div>
                            <form action="<?php echo ($basePath . '/pms_module/action/hr_panel.php'); ?>" method="post">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">JOB KNOWLEDGE</label>
                                    <div class="col-sm-6">
                                        <input type="number" value="" class="form-control" id="basic-default-company" name="JOB_KNOWLEDGE" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">TRANSPERANCY</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="TRANSPERANCY" value="" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">OWNERSHIP CAN DO</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="OWNERSHIP_CAN_DO" value=""
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">COMMUNICATION SKILL</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="COMMUNICATION_SKILL" value=""
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">TEAM WORK</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="TEAM_WORK" value="" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">CREATIVITY MAKER</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="CREATIVITY_MAKER" value=""
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">LEADERSHIP</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="LEADERSHIP" value="" required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">CUSTOMER RESPONSIBILITY</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="CUSTOMER_RESPONSIBILITY" value=""
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">PROBLEM SOLVING</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="PROBLEM_SOLVING" value=""
                                            required />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label" for="basic-default-company">WORK ETHICS</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" id="basic-default-company" name="WORK_ETHICS" value="" required />
                                    </div>
                                </div>
                                <div class="text-right">
                                    <button type="submit" name="submit_draft" class="btn btn-sm btn-info">Draft
                                        <i class="bx bxl-codepen"></i>
                                    </button>
                                    <button type="submit" name="submit_confirm" class="btn btn-sm btn-warning">Confirm
