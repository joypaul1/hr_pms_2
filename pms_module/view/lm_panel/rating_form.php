            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">    
                        <div class="shadow-sm p-2 mb-3 text-center text-info rounded font-weight-bold"><i class='bx bxs-shield-alt-2'></i>[Note :     Here You Can Set Achivement Rating Value] <i class='bx bxs-shield-alt-2'></i></div>
                            <div class='card card-body '>
