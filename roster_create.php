					...
					<div class="row"> 
					    <div class="col-sm-4">
							<div class="form-group">
								...
								<input name="rml_id" form="Form1" class="form-control"  type='text' value='<?php echo isset($_POST['ref_code']) ? $_POST['ref_code'] : ''; ?>' />
							</div>
						</div>
					</div>
					<script>
					...
					<div class="row"> 
						...
						<div class="col-sm-4">
								<div class="form-group">
								  ...
								  <div id="branch_name">
								    <select name="department_name" required="" class="form-control" id="department_name" form="Form1">
								      <option selected value="--">--</option>  
								    </select>
								  </div>
								</div>
					 ...
					 <div class="resume-item d-flex flex-column flex-md-row">
					   ...
					   <table class="table table-bordered piechart-key" id="admin_list" style="width:100%">  
						<thead class="table-dark">
							<tr>
							  <th scope="col">Sl</th>
							  <th scope="col"><center><input type="button" id="toggle" value="Select All" onClick="do_this()" /></center></th>  
						...
						if(isset($_POST['rml_id'])){
		                  ...
		                  while($row=oci_fetch_assoc($strSQL)){	
                           ...
                           ?>
							...
							<td align="center">
								<input type="checkbox" name="check_list[]" value="<?php echo $row['RML_ID'];?>" 
								style="text-align: center; vertical-align: middle;horiz-align: middle;">
							</td>
							<td><?php echo '<i style="color:red;"><b>'.$row['RML_ID'].'</b></i> ';?></td>
							<td><?php echo '<i style="color:red;"><b>'.$row['R_CONCERN'].'</b></i> ';?></td>
							<td><?php echo '<i style="color:red;"><b>'.$row['DEPT_NAME'].'</b></i> ';?></td>
							<td><?php echo '<i style="color:red;"><b>'.$row['BRANCH_NAME'].'</b></i> ';?></td>
							<td><?php echo '<b>'.$row['DESIGNATION'].'</b>';?></td>
						 </tr>
						 <?php
						  } ?>
						   <tr>
