...
if (isset($_POST['submit_approval_single'])) {
    ...
    if (!empty($_POST['check_list'])) {
        foreach ($_POST['check_list'] as $TT_ID_SELECTTED) {
            $sql    = "UPDATE RML_HR_ATTN_DAILY set LINE_MANAGER_APPROVAL=1,
						IS_ALL_APPROVED=1,
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="">
        ...
        <div class="card  col-lg-12 mt-2">
            <h5 class="card-header"><i class="menu-icon tf-icons bx bx-list-ul" style="margin:0;font-size:30px"></i><b>Concern Attendance Approval
                    List</b></h5>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-primary btn pull-right" form="Form2" type="submit" name="submit_approval_single"
                                                value="Approve">
                                        </td>
                                        <td>
