                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div id="branch_name">
                                <select name="department_name" required="" class="form-control cust-control" id="department_name" form="Form1">
                                    <option selected value="--">--</option>
                                </select>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered piechart-key" id="admin_list" style="width:100%">
									...
									FROM RML_HR_APPS_USER
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <input class="btn btn-primary btn pull-right" type="submit" name="submit_approval"
                                                    value="Create Roster" />
                                            </td>
                                            <td></td>
                                            <td></td>
