			...
			if(isset($_POST['emp_id'])){
			   ...
			   $strSQL  = oci_parse($objConnect, 
			            "SELECT 
							...
							MAIL,
							USER_CREATE_DATE
							FROM RML_HR_APPS_USER A WHERE IS_ACTIVE=1 AND RML_ID ='$v_emp_id' AND R_CONCERN='RMWL'"); 
				@oci_execute($strSQL);
				$number=0;	
						    ...
						    <div class="col-sm-6">
								<div class="row">
								  ...
								  <div class="col-sm-6">
									...
									<input type="text" class="form-control" form="Form2" name="emp_id"  value="<?php echo $row['RML_ID']; ?>"  readonly />
								  </div>
								</div>
								...
								<div class="row mt-2">
								  <div class="col-sm-6">
									...
									<input type="text" class="form-control" value="<?php echo $row['BRANCH_NAME']; ?>" readonly />
								  </div>
								  <div class="col-sm-6">
								    <label for="title">User Created</label>
									<input type="text" class="form-control" value="<?php echo $row['USER_CREATE_DATE']; ?>" readonly />
								  </div>
								</div>
								...
								<div class="row mt-2">
								  <div class="col-sm-6">
									...
									<input type="text" class="form-control" value="<?php echo $row['R_CONCERN']; ?>" readonly />
								  </div>
								  <div class="col-sm-6">
								    <label for="title">EMP Grpup</label>
									<input type="text" class="form-control" value="<?php echo $row['EMP_GROUP']; ?>" readonly />
								  </div>
								</div>
						        <div class="row mt-2">
								  <div class="col-sm-6">
								    <label for="title">Line Manager-1</label>
									<input type="text" class="form-control" value="<?php echo $row['LINE_MANAGER_1']; ?>" readonly />
								  </div>
								  <div class="col-sm-6">
								    <label for="title">Line Manager-2</label>
									<input type="text" class="form-control" value="<?php echo $row['LINE_MANAGER_2']; ?>" readonly />
								  </div>
								</div>
					...
					<div class="col-sm-6">
					    <div class="row">
							  <div class="col-sm-12">
								...
								<div class="input-group">
										...
										<input required=""  form="Form2"  class="form-control"  type='date' name='form_effect_date' value='<?php echo isset($_POST['form_effect_date']) ? $_POST['form_effect_date'] : ''; ?>' />
								</div>
							  </div>  
						</div>
						<div class="row mt-2">
							<div class="col-sm-6">
								...
								<div class="input-group">
										...
										<input required=""  form="Form2"  class="form-control"  type='date' name='start_date' value='<?php echo isset($_POST['start_date']) ? $_POST['start_date'] : ''; ?>' />
								</div>
							</div>
                            <div class="col-sm-6">
								...
								<div class="input-group">
										...
										<input required=""  form="Form2"  class="form-control"  type='date' name='end_date' value='<?php echo isset($_POST['end_date']) ? $_POST['end_date'] : ''; ?>' />
								</div>
							</div> 							
						</div>
                        <div class="row mt-2">
							<div class="col-sm-6">
								<div class="form-group">
								  ...
								  <input name="ref_id_1" form="Form2" class="form-control"  type='text' value='<?php echo isset($_POST['ref_code']) ? $_POST['ref_code'] : ''; ?>' />
								</div>
							</div>
                            <div class="col-sm-6">
								<div class="form-group">
								  <label for="title">Responsible-2 ID:</label>
								  <input name="ref_id_2" form="Form2" class="form-control"  type='text' value='<?php echo isset($_POST['ref_code']) ? $_POST['ref_code'] : ''; ?>' />
								</div>
							</div> 							
						</div>
                        ...
                        <div class="row mt-2">
							<div class="col-sm-6">
							    <label for="title">Designation</label>
								<div class="input-group">
										<select required="" form="Form2"   name="emp_designation" class="form-control">
                            ...
                            <div class="col-sm-6">
								...
								<div class="input-group">
                                <select required="" form="Form2"   name="emp_branch" class="form-control">
								<option selected value="">--</option>
							    <?php
								$strSQL  = oci_parse($objConnect, 
						...
						<div class="row mt-2">
						    <div class="col-sm-12">
							    <label for="title">Department</label>
								<div class="input-group">
										<select required="" form="Form2" name="emp_department" class="form-control">
								<option selected value="">--</option>
							    <?php
								$strSQL  = oci_parse($objConnect, 
						...
						<div class="row mt-3">
							...
							<div class="col-sm-6">
							  <button form="Form2" type="submit" name="submit_leave" class="btn btn-primary btn pull-right form-control">Create Transfer</button>
							</div>
                        </div>
