			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						...
						<input readonly name="emp_id" class="form-control" type='text' value='<?php echo $emp_session_id; ?>' />
					</div>
				</div>
				<div class="col-sm-3">
					...
					<div class="input-group">
						...
						<input required="" type="date" name="start_date" class="form-control" id="title"
				...
				<div class="col-sm-3">
					...
					<div class="input-group">
						...
						<input required="" type="date" name="end_date" class="form-control" id="title"
