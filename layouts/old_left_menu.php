  ...
  <ul class="menu-inner py-1">
    ...
    <?php
      ...
      <li class="menu-item 
        ...
        <ul class="menu-sub">
          <?php if (checkPermission('leave-create')) {   ?>
      ...
      <li class="menu-item 
        ...
        <ul class="menu-sub">
          <?php if (checkPermission('tour-create')) {   ?>
          ...
          <?php } ?>
          <?php if (checkPermission('tour-list')) {   ?>
      ...
      <li class="menu-item 
        ...
        <ul class="menu-sub">
          <?php if (checkPermission('report-outdoor-attendance')) {   ?>
          ...
          <?php } ?>
          <?php if (checkPermission('report-self-attendance')) {   ?>
