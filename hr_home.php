 <?php
	$userStatusSQL  = oci_parse($objConnect, 
	...
	$monthly_late=0;
	$monthly_absent=0;
	$lateAbsentSQL  = oci_parse($objConnect, 
					 "select A.STATUS,COUNT(UNIQUE(A.RML_ID)) AS NUMNER_COUNT from RML_HR_ATTN_DAILY_PROC A,RML_HR_APPS_USER B
			...
			<div class="col-lg-4 col-md-4 order-1">
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                     ...
                     <img src="images/dashing_images.png" class="img-fluid" style="width: auto; height: 410px;">
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Late[This Month]</span>
                          <h3 class="card-title text-nowrap mb-2"><?php echo $monthly_late;?></h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Absent[This Month]</span>
                          <h3 class="card-title mb-2"><?php echo $monthly_absent;?></h3>
                          <small class="text-danger fw-semibold"><i class="bx bx-up-arrow-alt"></i> </small>
                        </div>
                      </div>
                    </div>
                    <!-- </div>
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title">
                                <h5 class="text-nowrap mb-2"><u>Today Joining User</u></h5>
                                <span class="badge bg-label-warning rounded-pill">Happy Joining</span>
                              </div>
                              <div class="mt-sm-auto">
                                
                                <h3 class="mb-0"><?php echo 'Total Count: '.$today_joining_user;?></h3>
                              </div>
                            </div>
                            <div id="">
							<img class="card-img-top" src="images/birthday_images.png" style="width: 150px; height: 150px;" />
							</div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="p-0 m-0 mt-3">
					    ...
					    <?php
						$attendanceSQL  = oci_parse($objConnect, 
                ...
                <div class="col-md-6 col-lg-4 order-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2"><u>Concern Wise User Statistics</u></h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
					...
					<div class="card-body">
                      <ul class="p-0 m-0">
                       <?php
						$userStatusSQL  = oci_parse($objConnect, 
						                  "SELECT R_CONCERN,COUNT(R_CONCERN) AS TOTAL_EMP 
										          FROM RML_HR_APPS_USER 
												  WHERE IS_ACTIVE=1 
												  AND R_CONCERN!='RG'
												  GROUP BY R_CONCERN"); 
					   ...
					   <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              ...
                              <h6 class="mb-0"><?php echo $row['R_CONCERN'];?></h6>
                            </div>
