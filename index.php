...
if (isset($_POST['login_hr'])) {
  ...
  if (!empty($_POST['username_hr']) && !empty($_POST['password_hr'])) {
    $v_username     = trim($_POST['username_hr']);
    ...
    $rs_hr = mysqli_query($conn_hr, $sql);
    $getNumRows_hr = mysqli_num_rows($rs_hr);
...
if (isset($_GET['logout_hr']) && $_GET['logout_hr'] == true) {
  ...
  header("location:/rml_apps/index.php");
  exit;
}


if (isset($_GET['lmsg_hr']) && $_GET['lmsg_hr'] == true) {
  //$errorMsg = "lmsg_hr==true";
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            <!-- Logo -->
            <div class="app-brand justify-content-center border border-secondary">
              <a href="" class="app-brand-link gap-2">
                ...
                <span class="demo menu-text ms-2 mt-3">
                  <h3><b>Apps Admin Login</b></h3>
                </span>
                <!--<span class="app-brand-text demo fw-bolder">Apps Admin Login</span> -->
              </a>
            </div>

            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Rangs Group! 👋</h4>
            <p class="mb-4">Please sign-in to your account and start the Apps Admin Panel.</p>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" type="submit" name="login_hr">Sign
                  in</button>
              </div>
            </form>
