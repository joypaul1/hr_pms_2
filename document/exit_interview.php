            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_1" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_2" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_3" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_4" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_5" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_6" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_7" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_8" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_9" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_10" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_11" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_12" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_13" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_14" value="no">
                            No
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; overflow: hidden;">
                        ...
                        <label>
                            <input type="radio" name="reason_15" value="no">
                            No
                        </label>
                    </td>
                </tr>
